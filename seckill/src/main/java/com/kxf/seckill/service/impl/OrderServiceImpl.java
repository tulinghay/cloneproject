...
import com.kxf.seckill.mapper.OrderMapper;
import com.kxf.seckill.pojo.Order;
import com.kxf.seckill.pojo.SeckillGoods;
...
import com.kxf.seckill.service.ISeckillGoodsService;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Order> implements IOrderService {
    ...
    public String createPath(User user, Long goodsId) {
        ...
        redisTemplate.
                opsForValue().set("seckillPath:" + user.getId() + ":" + goodsId, str, 60, TimeUnit.SECONDS);
        return str;
    }
